            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="header-navbar-collapse">
                    ...
                    <div class="navbar-right btns">
                        ...
                        <a class="btn btn-default navbar-btn sign-in" data-sign="signin" data-toggle="modal" href='/user'>消息</a>
                    ...
                    <form class="navbar-form navbar-right" action="search" method="get" role="search">
                        <div class="form-group">
                            <Search @search="search" v-model="keyword" v-width="300" showSearchButton placeholder="搜索 课程/问答"><i class="h-icon-search"></i></Search>
                        </div>
                    </form>
                </div>
            </div>
                    ...
                    <div v-if="login_or_regist=='登录'"  style='padding:20px 20px 0px 5px'>
                        ...
                        <form action="/login" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div v-width="300"><Button class="h-btn h-btn-text-green h-btn-block" @click="login">进入实验楼</Button></div>

                            </div>
                            <div class="form-group widget-signin">
                                <img :src="sinaimg" style="cursor:pointer" @click="sina">
                                <img :src="dingimg" style="cursor:pointer" @click="dingding">
                            </div>
                        </form>
                    </div>
...
<script>
import {login_post, register_post, send_phone_code_post ,search_data_get} from '../axios_api/api'
